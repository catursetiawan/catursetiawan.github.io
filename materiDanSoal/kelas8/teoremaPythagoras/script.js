...
const tutupJawaban = document.querySelectorAll('.soal .answer .jawaban .tutupJawaban');
    ...
    for(let k =0; k<tutupJawaban.length; k++){
        tutupJawaban[k].addEventListener('click',function(){
            tutupJawaban[k].parentElement.classList.remove('terlihat'); 
        })
    }
